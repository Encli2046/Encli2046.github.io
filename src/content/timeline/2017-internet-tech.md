...
updated: 2026-05-12
category: "互联网时间线"
tags: ["2017", "React", "TensorFlow", "WebAssembly", "Kubernetes", "Node.js", "Android", "Apple", "TypeScript", "Kotlin", "CSS", "AI", "AR", "微信小程序"]
sourceType: "资料整理"
year: 2017
sources:
  - title: "WeChat's mini-programs roll out to the public in China"
    url: "https://techcrunch.com/2017/01/08/wechat-mini-programs/"
  ...
  - title: "WebAssembly consensus and end of Browser Preview"
    ...
    accessed: 2026-05-12
  - title: "CSS Grid Layout lands in Firefox 52"
    url: "https://hacks.mozilla.org/2017/03/css-grid-layout-lands-in-firefox-52/"
    publisher: "Mozilla Hacks"
    accessed: 2026-05-12
  - title: "Stack Overflow Developer Survey 2017 Results"
    url: "https://stackoverflow.blog/2017/03/22/stack-overflow-developer-survey-2017-results/"
    publisher: "Stack Overflow Blog"
    accessed: 2026-05-12
  - title: "Prettier 1.0"
    url: "https://prettier.io/blog/2017/04/13/1.0.0.html"
    publisher: "Prettier Blog"
    accessed: 2026-05-12
  ...
  - title: "Android announces support for Kotlin"
    ...
    accessed: 2026-05-12
  - title: "AlphaGo at The Future of Go Summit, 2017"
    url: "https://deepmind.google/blog/alphago-at-the-future-of-go-summit-2017/"
    publisher: "Google DeepMind"
    accessed: 2026-05-12
  - title: "npm v5.0.0"
    url: "https://blog.npmjs.org/post/161081169345/v500"
    publisher: "npm Blog"
    accessed: 2026-05-12
  - title: "Node.js 8.0.0 (Current)"
    ...
    accessed: 2026-05-12
  - title: "iOS 11 brings new features to iPhone and iPad this fall"
  ...
  - title: "Kubernetes 1.8: Security, Workloads and Feature Depth"
    ...
    accessed: 2026-05-12
  - title: "Docker Announces Kubernetes Integration for the Docker Platform"
  ...
  - title: "Production Ready Node.js 8.9.0 Brings Elegant Coding and Up to 20% Performance Boost in Web Applications"
    ...
    accessed: 2026-05-12
  - title: "Announcing TypeScript 2.6"
    url: "https://devblogs.microsoft.com/typescript/announcing-typescript-2-6/"
...
前端工具链在这一年进入标准化阶段：代码格式、依赖锁定、构建优化开始有社区共识。

移动生态分裂出两条线：iOS 和 Android 持续升级平台能力，微信小程序开辟了中国特有的轻应用通道。

## 2017/01/09 / 移动生态 / 微信小程序正式上线

微信小程序于 2017 年 1 月 9 日正式向用户开放，提供一种无需安装、基于微信生态的轻应用框架。

**影响判断：** 开辟了中国移动互联网独有的轻应用分发通道，让前端技术栈进入微信生态，也改变了后续几年中国开发者的技能结构和商业模式。
...
## 2017/03/07 / Web 标准 / CSS Grid Layout 主流浏览器全部支持

Firefox 52 发布 CSS Grid Layout 后，Chrome、Safari 和 Edge 在同一时间段内完成支持，Web 布局进入二维网格时代。

**影响判断：** CSS Grid 终结了前端开发者依赖浮动和弹性盒拼凑页面布局的长期状态，复杂页面布局从 hack 变成规范操作。

## 2017/03/22 / 开发者生态 / Stack Overflow 2017 开发者调查：JavaScript 连续五年第一

Stack Overflow 发布 2017 年开发者调查，JavaScript 连续五年为最常用语言，TypeScript 和 Rust 为最受喜爱语言。

**影响判断：** 大规模开发者调查数据成为观察技术趋势的重要参照，JavaScript 的统治地位和 TypeScript 的上升轨迹在统计层面被确认。

## 2017/04/13 / 前端工具链 / Prettier 1.0：JavaScript 代码格式化工具正式发布

Prettier 发布 1.0 版本，提供一套意见鲜明的 JavaScript 代码格式化方案，支持 JSX、Flow 和 TypeScript。

**影响判断：** 前端工具链进入标准化阶段，代码风格从人工约定走向自动化工具，降低了团队协作的格式摩擦，也影响了后续几年 ESLint 和编辑器生态的整合方向。
...
## 2017/05/17 / 移动平台 / Google I/O：Kotlin 成为 Android 官方一级语言

Google 在 I/O 2017 上宣布 Kotlin 成为 Android 官方支持的编程语言，所有 Android Studio 内置 Kotlin 工具。

**影响判断：** Android 生态的编程语言从 Java 独大转向 Kotlin 与 Java 并行，影响了后续几年移动端技术选型和团队技能规划。

## 2017/05/23 / 人工智能 / AlphaGo 对战柯洁：AI 在围棋领域超越人类顶峰

DeepMind 的 AlphaGo 在乌镇围棋峰会上以 3:0 战胜世界围棋冠军柯洁，随后宣布退役。

**影响判断：** AlphaGo 的胜利成为 AI 公众认知的分水岭，围棋从“人类智慧最后堡垒”变为 AI 优势领域，也引发了对通用人工智能更广泛的讨论。

## 2017/05/25 / JavaScript 生态 / npm 5.0.0 引入 package-lock.json

npm 发布 5.0.0 版本，引入 package-lock.json 文件来自动锁定依赖树，显著提升安装速度。

**影响判断：** npm 开始从单纯的包管理器演进为更完整的工程工具，依赖锁定成为现代 JavaScript 项目的标准行为，也间接影响了后续 Yarn 和 pnpm 的竞争。
...
## 2017/06/05 / 移动平台 / Apple WWDC：ARKit 发布

Apple 在 WWDC 2017 推出 ARKit，让数百万台 iPhone 和 iPad 变成增强现实设备。

**影响判断：** ARKit 大幅降低了增强现实应用开发的门槛，iOS 一夜之间成为全球最大的 AR 平台，也推动了后续几年 AR 应用和开发工具的发展。
...
## 2017/10/17 / 容器生态 / Docker 宣布原生集成 Kubernetes

Docker 在 DockerCon EU 上宣布 Docker EE 和 Docker Desktop 将原生集成 Kubernetes，用户无需单独安装和管理 K8s 集群。

**影响判断：** Kubernetes 在容器编排之战中的胜出被正式确认，Docker 从竞争者转为集成者，云原生基础设施的标准化进一步加速。
...
## 2017/10/31 / 编程语言 / TypeScript 2.6 发布

TypeScript 2.6 发布，引入 strict function types、本地化支持的 --locale 标志和更完善的 JSX 支持。

**影响判断：** TypeScript 在大型前端项目中的采用率持续上升，其类型系统和工具链开始成为许多团队前端工程化的默认选项。

## 2017/12/31 / 开源生态 / GitHub Octoverse 2017：JavaScript 和 Python 双极增长

GitHub Octoverse 2017 显示平台上有 337 种编程语言的项目，JavaScript 最活跃，Python 超过 Java 成为第二受欢迎语言。
